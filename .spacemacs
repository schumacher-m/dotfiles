...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(vue-mode all-the-icons spaceline
                                      spaceline-all-the-icons company
                                      editorconfig color-theme-solarized)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(color-theme-solarized-dark color-theme-solarized-light)
